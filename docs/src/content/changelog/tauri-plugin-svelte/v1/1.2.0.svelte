<script lang="ts">
  ...
  // prettier-ignore
  const url = {
    hooks: 'https://tb.dev.br/tauri-store/reference/tauri-plugin-svelte/interfaces/StoreHooks.html',
    onError: 'https://tb.dev.br/tauri-store/reference/tauri-plugin-svelte/interfaces/StoreFrontendOptions.html#onerror',
  };
</script>
