...
<main>
  ...
  <section id="debounced-counter">
    <p>Debounced Counter: {debouncedStore.state.debouncedCounter}</p>
    <div class="action">
      <button type="button" onclick={() => debouncedStore.state.debouncedCounter++}>
        Increment
      </button>
  ...
  <section id="throttled-counter">
    <p>Throttled Counter: {throttledStore.state.throttledCounter}</p>
    <div class="action">
      <button type="button" onclick={() => throttledStore.state.throttledCounter++}>
        Increment
      </button>
