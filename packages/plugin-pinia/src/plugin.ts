 ...
 *
 * [`TauriPluginPinia`]: https://tb.dev.br/tauri-store/js-docs/tauri-plugin-pinia/functions/TauriPluginPinia.html
 *
 * @example
 * ```ts
 ...
 *
 * [`createPlugin`]: https://tb.dev.br/tauri-store/js-docs/tauri-plugin-pinia/functions/createPlugin.html
 */
