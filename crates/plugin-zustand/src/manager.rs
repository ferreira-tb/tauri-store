...
/// Extension for the [`Manager`] trait providing access to the Zustand plugin.
///
...
pub trait ManagerExt<R: Runtime>: Manager<R> {
  ...
  fn zustand(&self) -> State<Zustand<R>> {
    self.app_handle().state::<Zustand<R>>()
  }
