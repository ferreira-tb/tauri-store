...
";
  ...
  const AUTOGENERATED_WARNING_XML: &str = "
<!--THIS FILE WAS AUTOGENERATED AND SHOULD NOT BE EDITED MANUALLY.
...
";
  ...
  const AUTOGENERATED_WARNING_HASHTAG: &str = "
# THIS FILE WAS AUTOGENERATED AND SHOULD NOT BE EDITED MANUALLY.
#
# Check the `codegen` command in the `tauri-store-cli` crate.
# https://github.com/ferreira-tb/tauri-store/tree/main/crates/tauri-store-cli
...
";
  ...
  pub fn prepend_autogenerated_xml(contents: &mut String) {
    let warning = AUTOGENERATED_WARNING_XML.trim_start();
    contents.push_str(warning);
  }

  pub fn prepend_autogenerated_hashtag(contents: &mut String) {
    let warning = AUTOGENERATED_WARNING_HASHTAG.trim_start();
    contents.insert_str(0, warning);
  }
